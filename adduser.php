...
if(isset($_POST['submit']) && $_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $existsql = "SELECT * FROM customer WHERE email = '".$email."' OR phone = '".$phone."'";
    ...
    if($existnumrows > 0){
       ...
       if(($password == $confirm_password)){
            ...
            $sql = "INSERT INTO `customer` ( `username`,`phone`,`email`, `password`) VALUES ('$fullname','$phone','$email', '$has')";
                ...
                <div class="card-body">
                    <form class="form-horizontal" id="signupForm1" novalidate="novalidate" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" maxlength="10" minlength="10" class="form-control" id="phone"
